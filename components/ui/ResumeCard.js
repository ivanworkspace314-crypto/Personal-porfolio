...
export default function ResumeCard({ year, title, description }) {
  return (
    <div className="border-[3px] border-[#7BE3F7] rounded-[4px] px-[25px] py-[40px] bg-transparent transition-all duration-300 ease-in-out hover:border-[#61D3ED] hover:shadow-[0_0_20px_rgba(97,211,237,0.3)] hover:bg-[#0C1B28]/10">
