    ...
    <>
     {/* Desktop Sidebar Navigation */}
      <aside className="w-[397px] h-screen bg-[#0C1B28] fixed left-0 top-0 [@media(max-width:1024px)]:w-[280px] [@media(max-width:768px)]:hidden">
        ...
        {/* Navigation Menu */}
        <nav className="flex flex-col gap-[6px] px-[73px] mt-[51px] [@media(max-width:1024px)]:px-[40px] [@media(max-width:1024px)]:mt-[40px]">
          <a href="/" className="flex items-center h-[75px] no-underline relative">
